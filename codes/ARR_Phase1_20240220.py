...
# size , demandRequired, riskLimit = 30, 0, 9999 # IEEE-30
# size , demandRequired, riskLimit = 118, 1140, 8900 # 1158, 9080 # IEEE-118
size , demandRequired, riskLimit = 300, 0, 999999
# size , demandRequired, riskLimit = 500, 6600, 7800
...
if feasibleSolution == True:
    ...
    df.to_csv('bestSwitchPhase1_%s.csv'%len(G.nodes()), index=False)
